...
def sinus_arrythmia():
    ...
    params = {
        'p': {'a': 0.25, 'd': 0.09, 't': 0.16},
        'q': {'a': 0.025, 'd': 0.066, 't': 0.05},
        'r': {'a': 1.6, 'd': 0.11, 't': 0.4},
        's': {'a': 0.25, 'd': 0.066, 't': 0.1},
        't': {'a': 0.35, 'd': 0.142, 't': 0.2},
        # 'u': {'a': 0.035, 'd': 0.0476, 't': 0.433}
    }
    li = 30/72
    return update_ecg()
...
def vfib():
    ...
    params = {
        'p': {'a': 0.3, 'd': 0.3, 't': 0.3},
        'q': {'a': 0.4, 'd': 0.066, 't': 0.166},
        'r': {'a': 0.8, 'd': 0.11, 't': 0.4},
        's': {'a': 0.5, 'd': 0.1, 't': 0.07},
        't': {'a': 0.6, 'd': 0.3, 't': 0.1},
        # 'u': {'a': 0.035, 'd': 0.0476, 't': 0.433}
    }
    li = 30/72
...
def atrial_tachy():
    global params, li
    params = {
        'p': {'a': 0.08, 'd': 0.09, 't': 0.48},
        'q': {'a': 0.025, 'd': 0.03, 't': 0.066},
        'r': {'a': 1.8, 'd': 0.11, 't': 0.4},
        's': {'a': 0.25, 'd': 0.066, 't': 0.1},
        't': {'a': 0.35, 'd': 0.142, 't': 0.2},
    }
    li = 30/72
...
def VT():
    global params, li
    params = {
        'p': {'a': 0.0, 'd': 0.1, 't': 0.16},
        'q': {'a': 0.025, 'd': 0.1, 't': 0.166},
        'r': {'a': 1.8, 'd': 0.11, 't': 0.4},
        's': {'a': 0.25, 'd': 0.066, 't': 0.09},
        't': {'a': 0.35, 'd': 0.4, 't': 0.7}
    }
    li = 30/72
    return update_ecg()
...
def aflutt():
    global params, li
    params = {
        'p': {'a': 0.35,    'd': 0.15,  't': 0.3},
        'q': {'a': 0.025,   'd': 0.066, 't': 0.09},          
        'r': {'a': 1.8,     'd': 0.11,   't': 0.2},
        's': {'a': 0.05,   'd': 0.066, 't': 0.09},
        't': {'a': 0.35,     'd': 0.142, 't': 0.2}
    }
    li = 30/72
    return update_ecg()
...
def multi_tachy():
    global params, li
    params = {
        'p': {'a': 0.37,    'd': 0.15,  't': 0.3},
        'q': {'a': 0.025,   'd': 0.066, 't': 0.1},          
        'r': {'a': 1.6,     'd': 0.1,   't': 0.4},
        's': {'a': 0.25,   'd': 0.1, 't': 0.1},
        't': {'a': 0.35,     'd': 0.14, 't': 0.1}         
    }
    li = 30/72
    return update_ecg()